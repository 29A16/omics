...
---
To address the quality of the [[Denovo Assambly|de novo]] sequence from [[Illumina technology|Illumina sequencing]], FastQC provides a quick way to check on some basic statistics. 
