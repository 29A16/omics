...
---
Gene prediction is used to identify genes after [[Denovo Assembly|assembling]] the sequence for annotation. The gene prediction software builds on **hidden markov models** and can either require training data or function independently.
