...
This approach doesn't rely on the use of theoretical spectra but takes previous measurements performed with the same setup to generate an annotated library for use on samples. This allows to use real world peak intensities and removes the reliance on external databases and trust in their quality.
